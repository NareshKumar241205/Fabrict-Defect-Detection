...
| **Seam Puckering** | 〽️ Laplacian Variance | Wrinkled seams indicating poor tension. |
...
* **🌡️ Saliency Heatmaps:** Visualizes "what the machine sees" for full explainability.
